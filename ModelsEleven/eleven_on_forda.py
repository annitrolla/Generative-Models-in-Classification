...
static_all = np.load('/storage/hpc_anna/GMiC/Data/FordA/preprocessed/train_static.npy')
dynamic_all = np.load('/storage/hpc_anna/GMiC/Data/FordA/preprocessed/train_dynamic.npy')
labels_all = np.load('/storage/hpc_anna/GMiC/Data/FordA/preprocessed/train_labels.npy')
