...
lstmoptim = 'adadelta'
lstmnepochs = 20
lstmbatchsize = 32 #1024

#
# Load the dataset
#
print 'Loading the dataset..'
static_all = np.load('/storage/hpc_anna/GMiC/Data/SpliceData/preprocessed/train_static.npy')
dynamic_all = np.load('/storage/hpc_anna/GMiC/Data/SpliceData/preprocessed/train_dynamic.npy')
labels_all = np.load('/storage/hpc_anna/GMiC/Data/SpliceData/preprocessed/train_labels.npy')
