...
# Split training
#
trainA_static = train_static[:660]
trainB_static = train_static[660:]
trainA_dynamic = train_dynamic[:660]
trainB_dynamic = train_dynamic[660:]
trainA_labels = train_labels[:660]
trainB_labels = train_labels[660:]
...
#predictions_combined_rf_hmm = np.concatenate((predictions_trainB_rf, ratios_trainB_hmm.reshape((ratios_trainB_hmm.shape[0], 1))), axis=1)
