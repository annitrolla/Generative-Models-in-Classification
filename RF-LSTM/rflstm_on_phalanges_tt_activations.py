...
train_static = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/train_static.npy')
train_dynamic = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/train_dynamic.npy')
train_labels = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/train_labels.npy')
train_nsamples = train_static.shape[0]

test_static = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/test_static.npy')
test_dynamic = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/test_dynamic.npy')
test_labels = np.load('/storage/hpc_anna/GMiC/Data/PhalangesOutlinesCorrect/preprocessed/test_labels.npy')
