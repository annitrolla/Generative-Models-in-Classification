...
# fill NAs
#train_static['End date'] = train_static['End date'].fillna("1970-01-01T00:00:01+00:00")
#train_static['Start date'] = train_static['End date'].fillna("1970-01-01T00:00:01+00:00")
#train_dynamic['timestamp'] = train_dynamic['timestamp'].fillna("1970-01-01T00:00:01+00:00")
#test_static['End date'] = test_static['End date'].fillna("1970-01-01T00:00:01+00:00")
#test_static['Start date'] = test_static['End date'].fillna("1970-01-01T00:00:01+00:00")
#test_dynamic['timestamp'] = test_dynamic['timestamp'].fillna("1970-01-01T00:00:01+00:00")
...
#train_static['End date'] = train_static.apply(lambda row: time.mktime(datetime.datetime.strptime(row['End date'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
#train_static['Start date'] = train_static.apply(lambda row: time.mktime(datetime.datetime.strptime(row['Start date'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
#train_dynamic['timestamp'] = train_dynamic.apply(lambda row: time.mktime(datetime.datetime.strptime(row['timestamp'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
#test_static['End date'] = test_static.apply(lambda row: time.mktime(datetime.datetime.strptime(row['End date'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
#test_static['Start date'] = test_static.apply(lambda row: time.mktime(datetime.datetime.strptime(row['Start date'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
#test_dynamic['timestamp'] = test_dynamic.apply(lambda row: time.mktime(datetime.datetime.strptime(row['timestamp'][:-6], "%Y-%m-%dT%H:%M:%S").timetuple()), axis=1)
