...
./cleanup.sh ~/Research/Generative-Models-in-Classification/Code/LSTM/spearmint/Generative/bpic/
python main.py ~/Research/Generative-Models-in-Classification/Code/LSTM/spearmint/Generative/bpic/
