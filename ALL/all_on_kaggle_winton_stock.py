...
static_train = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/train_static.npy')
dynamic_train = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/train_dynamic.npy')
static_val = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/test_static.npy')
dynamic_val = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/test_dynamic.npy')
labels_train = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/train_labels.npy')
labels_val = np.load('/storage/hpc_anna/GMiC/Data/Kaggle-Winton-Stock/preprocessed/test_labels.npy')
