...
dynamic_all = np.load('/storage/hpc_anna/GMiC/Data/Yoga/preprocessed/train_dynamic.npy')
labels_all = np.load('/storage/hpc_anna/GMiC/Data/Yoga/preprocessed/train_labels.npy')
