...
dynamic_all = np.load('/storage/hpc_anna/GMiC/Data/FordB/preprocessed/train_dynamic.npy')
labels_all = np.load('/storage/hpc_anna/GMiC/Data/FordB/preprocessed/train_labels.npy')
