...
raw_labels_test = np.loadtxt('../../Data/ECoG/Competition_test_lab.txt')
# map -1 and 1 to 0-1 and add to the train data
trainval_labels = (raw_labels + 1)/2
test_labels = (raw_labels_test + 1)/2
...
np.savetxt('../../Data/ECoG/Competition_test_lab_onezero.txt', test_labels, fmt='%d')